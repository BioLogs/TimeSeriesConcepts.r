...
These include moving averages and filtering, autoregressions and random walks. hese are some of the building blocks used to work with more advanced time series models and handle missing values.
